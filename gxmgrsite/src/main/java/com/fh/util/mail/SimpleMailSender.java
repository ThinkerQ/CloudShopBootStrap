...
/**   
  ...
  */    
    public boolean sendTextMail(MailSenderInfo mailInfo) throws Exception{    
      ...
      sendMailSession.setDebug(true);//设置为debug模式, 可以查看详细的发送 log
    ...
    public static void main(String[] args){   
        //这个类主要是设置邮件   
	     ...
	     mailInfo.setMailServerPort("25");    
	     mailInfo.setValidate(true);    
	     mailInfo.setUserName("18211674995@163.com");    
	     mailInfo.setPassword("qqq11024");//您的邮箱密码    
	     mailInfo.setFromAddress("itfather@1b23.com");    
	     mailInfo.setToAddress("1017649609@qq.com");    
