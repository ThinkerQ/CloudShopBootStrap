			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<thead>
					<tr>
						...
						<th class="center">主名称</th>
						<th class="center">副名称</th>
						<th class="center">创建时间</th>
						<th class="center">状态</th>
						<th class="center">小图URL</th>
						<th class="center">大图URL</th>
						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								...
								<td class='center' style="width: 30px;">${vs.index+1}</td>
										...
										<td>${var.firstName}</td>
										<td>${var.secondName}</td>
										<td>${var.createTime}</td>
										<td style="width: 60px;" class="center">
                                            <c:if test="${var.status == '1' }"><span class="label label-important arrowed-in">停用</span></c:if>
                                            <c:if test="${var.status == '0' }"><span class="label label-success arrowed">正常</span></c:if>
                                        </td>
										<td>${var.littleImgUrl}</td>
										<td>${var.bigImgUrl}</td>
